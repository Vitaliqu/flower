            ...
            {flowers
              ...
              .map((element, id) => (
                <li
                  ...
                  className={styles.searchArrayElement}
                  key={id}
                >
                  {element.name}
                </li>
            ...
            {isTablet && (
              <div className={styles.hamburgerMenu}>
                ...
                <img
                  ...
                  style={
                    isOpened
                      ? { opacity: "0", transform: "rotateZ(90deg)" }
                      : {}
                  }
                ...
                <img
                  ...
                  style={
                    isOpened
                      ? { opacity: "1", transform: "rotateZ(90deg)" }
                      : {}
                  }
                  onClick={() => {
                    setOpenedCategories(false);
            ...
            {!(isTablet && openSearch) && (
              ...
              >
                <p>
                  ...
                  <span style={{ color: "#79A03F", letterSpacing: "-2px" }}>
                    {" "}
                    O`N
                  </span>
                </p>
              ...
              !isTablet && (
                <div className={styles.navigationPanel}>
                  ...
                  <p
                    ...
                    style={path.includes(CATALOG_ROUTE) ? activeStyle : {}}
                  >
                    Каталог
                  </p>
                  <Item
                    path={DELIVERY_ROUTE}
                    label="Доставка"
                    active={path.includes(DELIVERY_ROUTE)}
                  />
                  <span
                    onClick={() =>
                      window.scrollTo({
